...
function buildDom() {
  return {
    ...
    measureLoading: document.getElementById("measure-loading"),
    measureLoadingTitle: document.getElementById("measure-loading-title"),
    measureLoadingStep: document.getElementById("measure-loading-step"),
